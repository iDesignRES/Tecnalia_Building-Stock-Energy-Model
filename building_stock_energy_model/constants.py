...
VERSION = 'v0.11.2'
DEFAULT_START_DATETIME = '2019-01-01T00:00:00'
DEFAULT_END_DATETIME = '2019-12-31T23:59:59'
DEFAULT_BUILDING_USE = 'Offices'
WINTER_TEMPERATURE = 12
SUMMER_TEMPERATURE = 22.5
COOLING_REDUCTION_FACTOR = 0.333
SAVE_RESULT_TO_EXCEL_ALLOWED = False
SAVE_RESULT_TO_SAMPLING_FILE_ALLOWED = False
LEVELS = ['High', 'Medium', 'Low']
CONVERT_COORD = False
RADIATION_DATABASE_URL = 'https://re.jrc.ec.europa.eu/api/v5_2/'
RADIATION_DATABASE_PRIMARY = 'PVGIS-SARAH2'
RADIATION_DATABASE_SECONDARY = 'PVGIS-ERA5'
NORMALIZED_REGIONS = {
    'IS00': 'NO06',
    'LI00': 'AT34'
}
...
REGIONS = 'AL01,AL02,AL03,AT11,AT12,AT13,AT21,AT22,AT31,AT32,AT33,AT34,' \
          ...
          'UA74,UA81,UA82,UA83,UKC1,UKC2,UKD1,UKD3,UKD4,UKD6,UKD7,UKE1,' \
          'UKE2,UKE3,UKE4,UKF1,UKF2,UKF3,UKG1,UKG2,UKG3,UKH1,UKH2,UKH3,' \
          'UKI3,UKI4,UKI5,UKI6,UKI7,UKJ1,UKJ2,UKJ3,UKJ4,UKK1,UKK2,UKK3,' \
          'UKK4,UKL1,UKL2,UKM5,UKM6,UKM7,UKM8,UKM9,UKN0,XK00'
